# ## Code in here is not being used now - it is moved to other files:
# - internal:  non-exposed functions for setup and fitting etc
# - download_data:  downloading data
# - estimate_cv19rr:  similar interface to EpiEstim
# - cv19rr:  S3 methods for the cv19rr class (TODO)
# - plot:  underlying functions supporting the plot method
# - autoplot:  underlying functions supporting the autoplot method (TODO)
#
